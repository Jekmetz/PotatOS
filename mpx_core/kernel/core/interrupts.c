...
void init_irq(void) {
  ...
  u32int isrs[17] = {(u32int)divide_error,  (u32int)debug,
                     (u32int)nmi,           (u32int)breakpoint,
                     (u32int)overflow,      (u32int)bounds,
                     (u32int)invalid_op,    (u32int)device_not_available,
                     (u32int)double_fault,  (u32int)coprocessor_segment,
                     (u32int)invalid_tss,   (u32int)segment_not_present,
                     (u32int)stack_segment, (u32int)general_protection,
                     (u32int)page_fault,    (u32int)reserved,
                     (u32int)coprocessor};
